// src/pages/ProgrammeDetail.tsx - FIXED: Removed duplicate Header/Footer
...
export default function ProgrammeDetail() {
  ...
  const { user } = useAuth()
  const [programme, setProgramme] = useState<ProgrammeDetailType | null>(null)
  ...
  useEffect(() => {
    async function fetchProgramme() {
      ...
      if (error) {
        ...
        setProgramme(data as ProgrammeDetailType)
